...
export default function ModuleActionSlides({ Left, children }) {
    return (
        <div className="flex items-center justify-between border m-1.5 p-2 gap-1.5 relative border-dashed">
            ...
            <span className="border-primary/20 bg-white dark:bg-zinc-800 absolute bottom-0 right-0 z-30 size-2.5 translate-x-1/2 translate-y-1/2 rotate-45 rounded-xs border"></span>
