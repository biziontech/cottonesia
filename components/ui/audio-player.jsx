...
import { Check, PauseIcon, PlayIcon, Gauge } from "lucide-react"
    ...
    const setActiveItem = useCallback(
        async (item) => {
            ...
            if (item === null) {
                ...
                audioRef.current.setAttribute('type', getMimeType(item.src))
    ...
    const play = useCallback(
        async (item) => {
            ...
            if (item === null) {
                ...
                console.log(getMimeType(item.src));
                audioRef.current.src = item.src
                audioRef.current.setAttribute('type', getMimeType(item.src))
                audioRef.current.load()
            }
